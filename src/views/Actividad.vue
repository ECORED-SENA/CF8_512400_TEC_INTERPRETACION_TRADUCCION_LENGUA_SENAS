  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Apropiar el conjunto de procesos y procedimientos que intervienen en la verificación de la calidad del servicio de interpretación tomando como base los requerimientos establecidos dentro de la comunidad sorda.
